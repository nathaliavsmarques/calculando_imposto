...
btn.addEventListener('click', function() {
    ...
    if (productPrice.value <= 0) {
        ...
        text.innerHTML = `Será cobrado ${taxOnProduct.toLocaleString('pt-br', { style: 'currency', currency: 'BRL' })} reais de imposto. Ao total você irá   
        pagar ${totalPrice.toLocaleString('pt-br', { style: 'currency', currency: 'BRL' })} reais.`;
